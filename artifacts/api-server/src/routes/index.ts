...
import correspondenceInternalRouter from "./correspondence-internal";
import secretariatRouter from "./secretariat";
import publicRelationsRouter from "./public-relations";
import delegationsRouter from "./delegations";
import permissionInspectorRouter from "./permission-inspector";
...
mountModule(router, "correspondenceInternal", correspondenceInternalRouter);
mountModule(router, "secretariat", secretariatRouter);
mountModule(router, "publicRelations", publicRelationsRouter);
mountModule(router, "delegations", delegationsRouter);
mountModule(router, "permissionInspector", permissionInspectorRouter);
mountModule(router, "security", securityRouter);
mountModule(router, "quality", qualityRouter);
mountModule(router, "announcements", announcementsRouter);
