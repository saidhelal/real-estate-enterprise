...
export default function CostCentersPage() {
  ...
  const columns: ResourceColumn<CostCenterDetail>[] = [
  ...
  return (
    <ResourceManager
      ...
      columns={columns}
      fields={fields}
      useList={useListCostCenters}
      useCreate={useCreateCostCenter}
      useUpdate={useUpdateCostCenter}
      useDelete={useDeleteCostCenter}
      getListQueryKey={getListCostCentersQueryKey}
      companyId={companyId}
    />
  );
}
