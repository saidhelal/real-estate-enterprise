...
const RAW_NAV_GROUPS: NavGroup[] = [
  ...
  { titleKey: "nav.group.engineering", items: [], subGroups: [
    { titleKey: "nav.group.eng_dashboard", items: [
      { href: "/engineering-dashboard", icon: Compass, labelKey: "nav.engineering_dashboard" },
    ]},
    { titleKey: "nav.group.eng_design", items: [
    ...
    { titleKey: "nav.group.eng_technical_office", items: [
    ...
    { titleKey: "nav.group.eng_execution", items: [
