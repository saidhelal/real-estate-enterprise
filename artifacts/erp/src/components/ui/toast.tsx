...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      // `end-2` rather than `right-2`: the app is RTL-first, so the dismiss
      // affordance has to follow the reading direction instead of pinning to
      // the physical right edge. Destructive-variant colours come from the
      // status tokens — a raw red would not track the theme.
